...
const leadCampaigns = [
  {
    ...
    message: 'Engaging young volunteers for climate action',
    recipients: 'Youth segment',
  },
];

export default function LeadCampaignTab() {
  return (
    <div>
      <h2 className="text-lg font-semibold mb-4">Lead Campaigns</h2>
